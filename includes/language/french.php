...
$txt['admin_action_generate_encrypt_keys'] = "Générer un nouvel ensemble de clés de chiffrement.";
...
$txt['admin_upload_title'] = "Envois";
$txt['admin_url_to_files_folder'] = "URL du répertoire Fichiers";
$txt['admin_url_to_upload_folder'] = "URL vers le répertoire Envois";
...
$txt['auth_creation_without_complexity'] = "Autoriser la création d'un élément sans que le niveau de complexité soit atteint";
$txt['auth_modification_without_complexity'] = "Autoriser la modification d'un élément sans que le niveau de complexité soit atteint";
...
$txt['bugs_page'] = "Si vous découvrez un défaut, vous pouvez directement le rapporter dans la section <a href='http://code.google.com/p/TeamPass/issues/list' target='_blank'><u>Bugs</u></a>.";
$txt['by'] = "par";
$txt['cancel'] = "Annuler";
...
$txt['channel_encryption_in_progress'] = "Canal en cours de chiffrement …";
$txt['channel_encryption_no_bcmath'] = "L'extension BCMATH n'est pas activée !";
$txt['channel_encryption_no_file'] = "Aucun fichier de clés de chiffrement n'a été trouvé !<br>Merci de relancer le processus de mise à jour.";
$txt['channel_encryption_no_file'] = "Fichier des clés de chiffrement non trouvé !<br>Merci de lancer la mise à jour.";
$txt['channel_encryption_no_gmp'] = "L'extention GMP n'est pas chargée ! Le chiffrement ne peut pas être initialisé.";
$txt['channel_encryption_no_openssl'] = "L'extention OpenSSL n'est pas chargée ! Le chiffrement ne peut pas être initialisé.";
...
$txt['email_body3'] = "'>ICI</a><br /><br />A bientôt.";
...
$txt['error_salt'] = "<b>La CLE de chiffrement est trop longue! Merci de ne pas utiliser l'outil tant qu'un Administrateur n'a pas modifié la CLE de chiffrement.</b> Dans le fichier settings.php, la longueur maximum autorisé pour SALT est 32 caractères.";
...
$txt['item_menu_copy_login'] = "Copier identifiant";
...
$txt['managers_of'] = "Gestionnaires du Rôle";
...
$txt['personal_salt_key_info'] = "Cette clé sera utilisée pour chiffrer et déchiffrer votre mot de passe.<br />Elle n'est pas sauvée en base de données et elle est seule connue de vous.<br />Ne la perdait surtout pas !";
...
$txt['settings_printing_tip'] = "Quand activé, un bouton sera rajouté sur la page d'accueil permettant à l'utilisateur d'imprimer un listing PDF des éléments auxquels il a accès. Attention, cette liste laisse apparaitre les mots de passe sans chiffrement.";
